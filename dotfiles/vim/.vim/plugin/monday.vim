...
" add custom Add_word_pair pattern
" 2004/10/14
...
call <SID>Add_word_pair('jan', 'feb')
call <SID>Add_word_pair('feb', 'mar')
call <SID>Add_word_pair('mar', 'apr')
"call <SID>Add_word_pair('apr', 'may')
"call <SID>Add_word_pair('may', 'june')
"call <SID>Add_word_pair('june', 'july')
"call <SID>Add_word_pair('july', 'aug')
call <SID>Add_word_pair('aug', 'sep')
call <SID>Add_word_pair('sep', 'oct')
call <SID>Add_word_pair('oct', 'nov')
call <SID>Add_word_pair('nov', 'dec')
call <SID>Add_word_pair('dec', 'jan')

call <SID>Add_word_pair('public', 'protected')
call <SID>Add_word_pair('protected', 'private')
call <SID>Add_word_pair('private', 'public')

" default Add_word_pair pattern
